...
BIPEDAL_CONFIG = {
    ...
    "critic_learning_rate": 1e-2,#1e-3, inc digit
...
BIPEDAL_HPARAMS = {
    "policy_learning_rate": random_search(3, 'loguniform', 1e-3, 5e-3),
    "critic_learning_rate": random_search(3, 'loguniform', 1e-3, 1e-4),
    "critic_hidden_size": [[64, 64], [128, 128], [256, 256], [400, 300]],
    "policy_hidden_size": [[64, 64], [128, 128], [256, 256], [400, 300]],
    "tau": random_search(3, 'uniform', 1e-3, 5e-3),
